...
public class LambdaMART extends Ranker {
    ...
    public void init()
    {
        ...
        //Create a table of candidate thresholds (for each feature). Later on, we will select the best tree split from these candidates        // 创建存放候选阈值（分裂点）的表
